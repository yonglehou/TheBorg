...
{
    // Based on http://blogs.msdn.com/b/dcook/archive/2008/11/25/creating-a-self-signed-certificate-in-c.aspx
    public class CertificateGenerator
    {
        ...
        public static X509Certificate2 CreateSelfSignCertificate(
            ...
            DateTime endTime)
        {
            var bytes = CreateSelfSignCertificatePfx(null, startTime, endTime);
        ...
        public static byte[] CreateSelfSignCertificatePfx(
            ...
            DateTime endTime)
        {
            return CreateSelfSignCertificatePfx(null, startTime, endTime);
        }
